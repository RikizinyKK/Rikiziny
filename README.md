...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Rikiziny Hub Premium Scripts") then
			makefolder("Rikiziny Hub Premium Scripts")
		end
		if not isfolder("Rikiziny Hub Premium Scripts/Blox Fruits/") then
			makefolder("Rikiziny Hub Premium Scripts/Blox Fruits/")
		end
		if not isfile("Rikiziny Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("Rikiziny Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("Rikiziny Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("Rikiziny Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("Rikiziny Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
